...
-- 3) RETORNAR EL ID_CLIENTE, ID_CUENTA Y ID_TARJETA_CREDITO DE LA TABLA MOVIMIENTO A 
--    LA TABLA PRESTAMO CUANDO EN LA TABLA MOVIMIENTO SE ASOCIE UN MONTO_SALIDA A UNA
--    TARJETA DE CREDITO, Y QUE A SU VEZ MARQUE EL PRESTAMO COMO PRESTAMO PERSONAL Y 
--    TIPO DE PAGO POR CREDITO.
...
-- 4) RETORNAR EL VALOR DE SALDO_DISPONIBLE A 2000 DE UNA TARJETA DE CREDITO
--    CUANDO EL MONTO_PRESTADO SE COMPLETE MEDIANTE LA RESTA DEL SALDO_ABONADO 
--    QUE SE REALICE. Crear un disparador AFTER UPDATE en la tabla PRESTAMO
...
-- 6) EL CAMPO ID_CLIENTE EN LA TABLA PRESTAMO SE INTRARA AUTOMÁTICAMENTE 
--    BASADO EN EL ID_CUENTA REFERENCIADO
