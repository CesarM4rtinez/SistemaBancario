...
-- CREADOR DEL CODIGO SQL -> CÉSAR OVIDIO MARTÍNEZ CHICAS.

CREATE DATABASE SISTEMA_BANCARIO
ON PRIMARY
(
  NAME='SISTEMA_BANCARIO_Primary', FILENAME='D:\Documentos\Trabajos\BASES DE DATOS SQL SERVER\SISTEMA BANCARIO\SISTEMA_BANCARIO.mdf',
  SIZE=8mb, FILEGROWTH=20%
),
FILEGROUP DATA DEFAULT
(
  NAME='SISTEMA_BANCARIO_DataDefault', FILENAME='D:\Documentos\Trabajos\BASES DE DATOS SQL SERVER\SISTEMA BANCARIO\SISTEMA_BANCARIO.ndf',
  SIZE=8mb, FILEGROWTH=20%
)
LOG ON
(
  NAME='SISTEMA_BANCARIO_log', FILENAME='D:\Documentos\Trabajos\BASES DE DATOS SQL SERVER\SISTEMA BANCARIO\SISTEMA_BANCARIO.ldf',
  SIZE=8mb, FILEGROWTH=20%
)
